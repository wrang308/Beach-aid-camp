...
class _groupState extends State<GroupRoute> {
  ...
  Future<String> loadPersonFromAssets() async{
    var url = 'https://wrang308.github.io/json/groups.json';
  ...
  Future loadPerson() async{
    ...
    Autogenerated group = new Autogenerated.fromJson(jsonResponse);
    print('group ${group.group[0].groupName}');
            ...
            return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index){
                      ...
                      itemBuilder: (BuildContext context2, int index2)
                  {
                    ...
                    return ListTile(
                      title: Text(snapshot.data.group[index].members[index2-1].name),
